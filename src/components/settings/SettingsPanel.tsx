...
import { APIProvider, AppSettings, ChatSettings } from '@/types/chat';
...
export const SettingsPanel = ({
  ...
  const [activeTab, setActiveTab] = useState<'providers' | 'llm' | 'image' | 'tts' | 'memory'>('providers')
  ...
  const tabs = [
    { id: 'providers', label: 'Inference Providers' },
    { id: 'llm', label: 'Chat Settings' },
